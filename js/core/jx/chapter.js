     ...
     var Chapter = new J.Class({
         ...
         httpcourseChapterAdd: function(pid) {
             ...
             if (name && !self.able) {
                 ...
                 var params = {
                     ...
                     parentsChapterId: pid
                 }
                 J.ajax({ url: "/courseChapter/add", type: 'POST' }, params, function(data) {
         ...
         httpcourseChapterUpdate: function(id) {
             ...
             if (name) {
                 ...
                 J.ajax({ url: "/courseChapter/update", type: 'POST' }, params, function(data) {
                     $('#chapterModal').modal('hide');
                     self.update();
                 });
             }
         ...
         httpcourseChapterDel: function(pid) {
             var self = this;
             J.ajax({ url: "/courseChapter/delete", type: 'GET' }, { courseChapterId: pid }, function(data) {
